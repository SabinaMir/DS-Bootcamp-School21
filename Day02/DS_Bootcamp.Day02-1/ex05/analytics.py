...
class Calculations:
    ...
    def fractions(self):
        ...
        logging.debug(f"Fractions calculated: Heads={head_fraction}%, Tails={tail_fraction}%")
...
class Analytics(Calculations):
    def predict_random(self, num_predictions):
        ...
        logging.debug(f"Random predictions generated: {predictions}")
        return predictions

    def predict_last(self):
        logging.debug("Returning last prediction.")
